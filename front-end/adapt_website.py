...
def UploadImage():
	...
	with open("/Users/suzukimiyuki/Desktop/sweng2/github/SWENG-35/front-end/original.txt") as f:
		cnt = 1
		for s_line in f:
			photo_title = str(cnt)
	...
	with open("/Users/suzukimiyuki/Desktop/sweng2/github/SWENG-35/front-end/target.txt") as f:
		cnt2 =0
		for s_line in f:
